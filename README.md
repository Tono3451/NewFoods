...
Al iniciar la aplicación y entrar, el usuario será redirigido a la página de login. Aquí se pueden tomar dos acciones, la primera es iniciar sesión con un usuario ya existente, aquí una cuenta de usuario válida:<br>
